 ...
 (is
  (=
   (->
    ...
    escape-sgr
    string/join)
   "[\"〠38;5;196;1〠red, contrast :low〠0;〠\" \"〠38;5;196;1〠red, contrast :medium〠0;〠\" \"〠38;5;196;1〠red, contrast :high〠0;〠\" \"〠38;5;172;1〠orange, contrast :low〠0;〠\" \"〠38;5;172;1〠orange, contrast :medium〠0;〠\" \"〠38;5;172;1〠orange, contrast :high〠0;〠\" \"〠38;5;178;1〠yellow, contrast :low〠0;〠\" \"〠38;5;178;1〠yellow, contrast :medium〠0;〠\" \"〠38;5;178;1〠yellow, contrast :high〠0;〠\" \"〠38;5;106;1〠olive, contrast :low〠0;〠\" \"〠38;5;106;1〠olive, contrast :medium〠0;〠\" \"〠38;5;106;1〠olive, contrast :high〠0;〠\" \"〠38;5;40;1〠green, contrast :low〠0;〠\" \"〠38;5;40;1〠green, contrast :medium〠0;〠\" \"〠38;5;40;1〠green, contrast :high〠0;〠\" \"〠38;5;39;1〠blue, contrast :low〠0;〠\" \"〠38;5;39;1〠blue, contrast :medium〠0;〠\" \"〠38;5;39;1〠blue, contrast :high〠0;〠\" \"〠38;5;141;1〠purple, contrast :low〠0;〠\" \"〠38;5;141;1〠purple, contrast :medium〠0;〠\" \"〠38;5;141;1〠purple, contrast :high〠0;〠\" \"〠38;5;201;1〠magenta, contrast :low〠0;〠\" \"〠38;5;201;1〠magenta, contrast :medium〠0;〠\" \"〠38;5;201;1〠magenta, contrast :high〠0;〠\" \"〠38;5;247;1〠gray, contrast :low〠0;〠\" \"〠38;5;247;1〠gray, contrast :medium〠0;〠\" \"〠38;5;247;1〠gray, contrast :high〠0;〠\"]")))
 ...
 (is
  (=
   (->
    ...
    escape-sgr
    string/join)
   "〠38;5;39〠┌〠0;〠〠38;5;39〠─〠0;〠 INFO \n〠38;5;39〠│〠0;〠  \n〠38;5;39〠│〠0;〠  Callout with type of :info\n〠38;5;39〠│〠0;〠  \n〠38;5;39〠└〠0;〠")))


(deftest
 sideline-callout-info-label
 (is
  (=
   (->
    (callout+
    ...
    escape-sgr
    string/join)
   "〠38;5;39〠┌〠0;〠〠38;5;39〠─〠0;〠 My custom label \n〠38;5;39〠│〠0;〠  \n〠38;5;39〠│〠0;〠  Callout with type of :info and custom :label\n〠38;5;39〠│〠0;〠  \n〠38;5;39〠└〠0;〠")))


(deftest
 sideline-callout-warning
 (is
  (=
   (->
    (callout+
...
(deftest
 marquee-sideline-callout-info-label
 (is
  (=
   (->
    (callout+
...
(deftest
 marquee-sideline-callout-warning
 (is
  (=
   (->
    (callout+
    ...
    escape-sgr
    string/join)
   "〠38;5;172〠  ┌───────────┐〠0;〠\n〠38;5;172〠┌─┤  〠0;〠〠〠WARNING〠0;〠  〠38;5;172〠│〠0;〠\n〠38;5;172〠│ └───────────┘〠0;〠\n〠38;5;172〠│〠0;〠  \n〠38;5;172〠│〠0;〠  Callout with type of :warning\n〠38;5;172〠│〠0;〠  This is not a real warning\n〠38;5;172〠│〠0;〠  \n〠38;5;172〠└〠0;〠")))


(deftest
 marquee-sideline-callout-error
 (is
  (=
   (->
    (callout+
...
(deftest
 marquee-sideline-callout-positive-label
 (is
  (=
   (->
    (callout+
