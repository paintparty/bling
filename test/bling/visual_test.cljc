...
(let [c " * "]
  (print-bling 
   "\n\n"
   [:bold.light-red-bg.dark-red c]
   [:bold.black-bg.light-red c]
   [:bold.light-orange-bg.dark-orange c]
   [:bold.black-bg.light-orange c]
   "\n"
   [:bold.black-bg.light-yellow c]
   [:bold.light-yellow-bg.dark-yellow c]
   [:bold.black-bg.light-green c]
   [:bold.light-green-bg.dark-green c]
   "\n"
   [{:font-weight :bold :background-color 86 :color 28} c]
   [{:font-weight :bold :background-color :black :color 86} c]
   [:bold.light-blue-bg.white c]
   [:bold.black-bg.light-blue c]
   "\n"
   [:bold.black-bg.light-purple c]
   [:bold.light-purple-bg.white c]
   [:bold.black-bg.light-magenta c]
   [:bold.light-magenta-bg.white c]
   ))
...
(let [c " * "]
  (print-bling 
   ...
   [:bold.light-green-bg.dark-green c]
   [{:font-weight :bold :background-color :black :color 86} c]
   [:bold.light-olive-bg.dark-olive c]
   "\n"
   [:bold.black-bg.light-green c]
   [{:font-weight :bold :background-color 86 :color 28} c]
   [:bold.black-bg.light-olive c]
   "\n"
   [:bold.light-blue-bg.white c]
   [:bold.black-bg.light-purple c]
   [:bold.light-magenta-bg.white c]
...
(let [c " * "]
  (print-bling 
   ...
   "\n"
   [{:font-weight :bold :background-color :black :color 86} " * "]
